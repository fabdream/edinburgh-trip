...
const RESTAURANTS = [
  // PROCHES (< 5 min)
  { nom: 'Urban Angel', adresse: '121 Hanover Street', distance: '0 min de l\'hôtel', type: 'Brunch et café healthy, bio', budget: '€€ (£8–14)', ambiance: 'cosy, calme, bio et local', giuliaFriendly: true, phone: '0131 225 6215', horaires: 'ouvert 8h30–15h30 uniquement' },
  ...
  { nom: 'The Cambridge Bar', adresse: '20 Young Street', distance: '5 min à pied', type: 'Burgers gourmet dans un pub', budget: '€€ (£10–16)', ambiance: 'pub décontracté, sans chichi', giuliaFriendly: true, phone: '0131 226 2120', note: 'Les meilleurs burgers du quartier — idéal en mode no-brainer le midi' },
  { nom: 'Café St Honoré', adresse: '34 NW Thistle Street Lane', distance: '5 min à pied', type: 'Bistrot français raffiné mais pas guindé', budget: '€€€ (£22–32)', ambiance: 'intime, classe, comme à Paris', giuliaFriendly: true, phone: '0131 226 2211' },
  ...
  // MOYENS (5–15 min)
  { nom: 'The Piemaker', adresse: '38 South Bridge', distance: '8 min à pied', type: 'Pies écossaises artisanales (haggis, steak, mac & cheese)', budget: '€ (£4–7)', ambiance: 'comptoir rapide, zéro chichi', giuliaFriendly: true, note: 'La pie mac & cheese = rêve de toddler. Counter service, parfait quand on a faim vite' },
  { nom: 'Civerinos', adresse: '5 Hunter Square (Royal Mile)', distance: '10 min à pied', type: 'Pizza New York style à la part', budget: '€ (£5–12)', ambiance: 'super casual, counter service', giuliaFriendly: true, phone: '0131 556 5882', note: 'Parts géantes, pas d\'attente — parfait quand Giulia craque et qu\'on a besoin de manger VITE' },
  { nom: 'Vittoria', adresse: '19 George IV Bridge', distance: '10 min à pied', type: 'Trattoria italienne familiale depuis 1970', budget: '€€ (£10–18)', ambiance: 'vieille école italienne, nappes à carreaux, zéro prétention', giuliaFriendly: true, phone: '0131 225 1740', note: 'Institution familiale — ils adorent les enfants. Menu kids, crayons, chaises hautes' },
  { nom: 'Bertie\'s Fish & Chips', adresse: '9 Victoria Street, Old Town', distance: '10 min à pied', type: 'Fish & chips écossais authentique', budget: '€ (£7–12)', ambiance: 'coloré, décontracté', giuliaFriendly: true, phone: '0131 322 1000', note: 'Sur la fameuse rue colorée de Victoria Street — cuisine ouverte, Giulia peut regarder' },
  { nom: 'Mums Great Comfort Food', adresse: '4A Forrest Road', distance: '12 min à pied', type: 'Comfort food écossais — saucisses-purée, pies, mac & cheese, haggis', budget: '€€ (£8–14)', ambiance: 'rétro, tables en Formica, ketchup sur la table, ZÉRO chichi', giuliaFriendly: true, phone: '0131 260 9806', note: 'LE resto le moins guindé d\'Édimbourg — portions gigantesques, menu kids, sticky toffee pudding légendaire. Ouvert 9h–22h' },
  { nom: 'Bread Meats Bread', adresse: '2 Lothian Road', distance: '12 min à pied', type: 'Smash burgers, poulet frit, milkshakes', budget: '€€ (£10–16)', ambiance: 'street food bruyant — personne ne remarque le bazar de bébé', giuliaFriendly: true, phone: '0131 285 1288', note: 'Burgers cultes d\'Édimbourg. Milkshakes = arme secrète pour calmer Giulia' },
  { nom: 'L\'Alba D\'Oro', adresse: '5-7 Henderson Row', distance: '12 min à pied', type: 'Chippy italo-écossais — fish & chips + pizza', budget: '€ (£6–10)', ambiance: 'takeaway avec coin assis, familial', giuliaFriendly: true, phone: '0131 557 2580', note: 'Légende locale — la fusion chippy écossais + cuisine italienne, unique à Édimbourg' },
  { nom: 'The Last Drop', adresse: '74-78 Grassmarket', distance: '12 min à pied', type: 'Pub écossais traditionnel — haggis, pies, fish & chips', budget: '€€ (£8–15)', ambiance: 'pub spacieux, familial en journée', giuliaFriendly: true, phone: '0131 225 4851', note: 'Spacieux = poussette OK. Grassmarket dehors est top pour que Giulia se dégourdit après' },
  { nom: 'Mary\'s Milk Bar', adresse: '19 Grassmarket', distance: '12 min à pied', type: 'Gelato artisanal, hot chocolate, glaces', budget: '€ (£3–6)', ambiance: 'petit comptoir mignon', giuliaFriendly: true, phone: '0131 602 5731', note: 'Le meilleur hot chocolate d\'Édimbourg — même en février c\'est un incontournable' },
  { nom: 'The Pantry', adresse: '1 North West Circus Place, Stockbridge', distance: '12 min à pied', type: 'Brunch écossais fait maison — pancakes, granola, Scottish breakfast', budget: '€€ (£8–14)', ambiance: 'cosy, chaleureux', giuliaFriendly: true, phone: '0131 629 0206', note: 'Tout est fait maison — allez-y tôt le weekend (queue possible). Porridge et pancakes = Giulia approuve' },
  { nom: 'Cannonball Restaurant', adresse: '356 Castlehill, Royal Mile', distance: '15 min à pied', type: 'Écossais — haggis bon bons, cullen skink, steak pies', budget: '€€€ (£15–25 au bar)', ambiance: 'vue spectaculaire sur le château, bar décontracté', giuliaFriendly: true, phone: '0131 225 1550', note: 'Menu bar accessible (pas guindé). Vue imprenable. Haggis bon bons = à goûter absolument' },
...
const BALADES = [
  ...
  { nom: 'New Town Architecture Walk', description: 'Charlotte Square, Heriot Row, Moray Place — architecture géorgienne classée UNESCO', duree: '45 min', difficulte: 'Facile', poussetteOk: true, depart: '5 min de l\'hôtel', envies: ['architecture', 'calme', 'élégant', 'historique'] },
  { nom: 'Dean Village Loop', description: 'Descente vers l\'ancien village de meuniers au bord de la rivière', duree: '45min–1h', difficulte: 'Facile', poussetteOk: true, depart: '15 min de l\'hôtel', envies: ['pittoresque', 'nature', 'calme', 'village'] },
  { nom: 'Calton Hill Sunset Walk', description: 'Montée douce pour une vue panoramique spectaculaire sur toute la ville', duree: '30–40 min', difficulte: 'Moyen (montée 10 min)', poussetteOk: false, note: 'Porte-bébé indispensable', depart: '15 min de l\'hôtel', envies: ['vue', 'panorama', 'coucher de soleil', 'photo'] },
  { nom: 'Stockbridge & Circus Lane', description: 'Quartier bohème + Circus Lane, la plus jolie petite ruelle instagrammable de la ville', duree: '1h', difficulte: 'Facile', poussetteOk: true, depart: '20 min à pied', envies: ['pittoresque', 'photo', 'local', 'shopping'] },
  { nom: 'Royal Botanic Garden', description: 'Serres tropicales chauffées + jardins avec écureuils et playground', duree: '1h–1h30', difficulte: 'Facile, plat', poussetteOk: true, depart: '20 min via Stockbridge', envies: ['nature', 'jardin', 'calme', 'tropiques'] },
  { nom: 'Portobello Beach', description: 'La plage d\'Édimbourg — sable, vagues et promenade avec cafés', duree: '1h', difficulte: 'Facile', poussetteOk: true, note: 'Le sable peut bloquer la poussette — porte-bébé sur la plage', depart: '20 min en bus ou taxi', envies: ['plage', 'nature', 'espace', 'dépaysement'] },
  { nom: 'Holyrood Park & Loch', description: 'Tour du loch avec canards et cygnes, au pied d\'Arthur\'s Seat', duree: '45 min', difficulte: 'Facile, plat autour du loch', poussetteOk: true, depart: '20 min à pied', envies: ['nature', 'animaux', 'calme', 'historique'] },
];
